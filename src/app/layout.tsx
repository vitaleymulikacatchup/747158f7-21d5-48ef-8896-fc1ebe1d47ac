...
export const metadata: Metadata = {
  title: "AutoVista | Premium Vehicles & Expert Service",
  description: "Discover premium vehicles at AutoVista. Expert guidance, competitive financing, and exceptional customer service since 1999.",
  keywords: "car dealership, luxury vehicles, used cars, financing, test drive",
  metadataBase: new URL("https://autovista.com"),
  alternates: {
    canonical: "https://autovista.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "AutoVista | Premium Vehicles & Expert Service",
    description: "Discover premium vehicles at AutoVista. Expert guidance, competitive financing, and exceptional customer service.",
    type: "website",
    siteName: "AutoVista",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765880298391-atyanl1t.jpg",
        alt: "AutoVista Premium Vehicle Showcase"
      }
    ]
  },
  twitter: {
    ...
    title: "AutoVista | Premium Vehicles & Expert Service",
    description: "Discover premium vehicles at AutoVista with expert guidance and competitive financing.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765880298391-atyanl1t.jpg"]
  }
};
